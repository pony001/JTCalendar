...
@implementation PJTCalendarContentView
...
- (void)commonInit
{
    ...
    for(int i = 0; i < NUMBER_PAGES_LOADED; ++i){
        PJTCalendarMonthView *monthView = [PJTCalendarMonthView new];
...
- (void)setCurrentDate:(NSDate *)currentDate
{
    ...
    for(int i = 0; i < NUMBER_PAGES_LOADED; ++i){
        PJTCalendarMonthView *monthView = monthsViews[i];
...
- (void)setCalendarManager:(PJTCalendar *)calendarManager
{
    ...
    for(PJTCalendarMonthView *view in monthsViews){
...
- (void)reloadData
{
    for(PJTCalendarMonthView *monthView in monthsViews){
