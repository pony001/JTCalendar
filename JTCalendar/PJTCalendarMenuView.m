...
#import "PJTCalendarMenuMonthView.h"

#define NUMBER_PAGES_LOADED 2 // Must be the same in JTCalendarView, JTCalendarMenuView, JTCalendarContentView

@interface PJTCalendarMenuView(){
    NSMutableArray *monthsViews;
}

@end

@implementation PJTCalendarMenuView
...
- (void)commonInit
{
    ...
    for(int i = 0; i < NUMBER_PAGES_LOADED; ++i){
        PJTCalendarMenuMonthView *monthView = [PJTCalendarMenuMonthView new];
...
- (void)setCurrentDate:(NSDate *)currentDate
{
    ...
    for(int i = 0; i < NUMBER_PAGES_LOADED; ++i){
        PJTCalendarMenuMonthView *monthView = monthsViews[i];
...
- (void)setCalendarManager:(PJTCalendar *)calendarManager
{
    ...
    for(PJTCalendarMenuMonthView *view in monthsViews){
