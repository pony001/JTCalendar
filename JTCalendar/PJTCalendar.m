...
- (instancetype)init
{
    ...
    self->_calendarAppearance = [PJTCalendarAppearance new];
    self->_dataCache = [PJTCalendarDataCache new];
...
- (void)setMenuMonthsView:(PJTCalendarMenuView *)menuMonthsView
{
    [self->_menuMonthsView setDelegate:nil];
...
- (void)setContentView:(PJTCalendarContentView *)contentView
{
    [self->_contentView setDelegate:nil];
